...
The `ralph()` retry wrapper creates its own separate plain-text log file at:
...
- **CLI:** pass `--verbose` to the `run` command: `antkeeper run --verbose sdlc prompts/add-auth.md`
